...

{
  ...
  if(triorg[0]==0 && triorg[1]==0)return 1;
  if(tridest[0]==0 && tridest[1]==0)return 1;
  if(triapex[0]==0 && triapex[1]==0)return 1;

  if(area>0.05)return 1;
...

{
  ...
  INEXACT REAL Qnew=0;
  INEXACT REAL hh=0;
  INEXACT REAL bvirt=0;
  REAL avirt=0, bround=0, around=0;
...
{
  INEXACT REAL acx=0, acy=0, bcx=0, bcy=0;
  REAL acxtail=0, acytail=0, bcxtail=0, bcytail=0;
  INEXACT REAL detleft=0, detright=0;
  REAL detlefttail=0, detrighttail=0;
  REAL det=0, errbound=0;
  REAL B[4]={0}, C1[8]={0}, C2[12]={0}, D[16]={0};
  INEXACT REAL B3=0;
  int C1length=0, C2length=0, Dlength=0;
  REAL u[4]={0};
  INEXACT REAL u3=0;
  INEXACT REAL s1=0, t1=0;
  REAL s0=0, t0=0;
  ...
  INEXACT REAL c=0;
  INEXACT REAL abig=0;
  REAL ahi=0, alo=0, bhi=0, blo=0;
  REAL err1=0, err2=0, err3=0;
  INEXACT REAL _i=0, _j=0;
  REAL _0=0;
...
{
  REAL detleft=0, detright=0, det=0;
  REAL detsum=0, errbound=0;
...
{
  INEXACT REAL adx=0, bdx=0, cdx=0, ady=0, bdy=0, cdy=0;
  REAL det=0, errbound=0;

  INEXACT REAL bdxcdy1=0, cdxbdy1=0, cdxady1=0, adxcdy1=0, adxbdy1=0, bdxady1=0;
  REAL bdxcdy0=0, cdxbdy0=0, cdxady0=0, adxcdy0=0, adxbdy0=0, bdxady0=0;
  REAL bc[4]={0}, ca[4]={0}, ab[4]={0};
  INEXACT REAL bc3, ca3, ab3;
  REAL axbc[8]={0}, axxbc[16]={0}, aybc[8]={0}, ayybc[16]={0}, adet[32]={0};
  int axbclen=0, axxbclen=0, aybclen=0, ayybclen=0, alen=0;
  REAL bxca[8]={0}, bxxca[16]={0}, byca[8]={0}, byyca[16]={0}, bdet[32]={0};
  int bxcalen=0, bxxcalen=0, bycalen=0, byycalen=0, blen=0;
  REAL cxab[8]={0}, cxxab[16]={0}, cyab[8]={0}, cyyab[16]={0}, cdet[32]={0};
  int cxablen=0, cxxablen=0, cyablen=0, cyyablen=0, clen=0;
  REAL abdet[64]={0};
  int ablen=0;
  REAL fin1[1152]={0}, fin2[1152]={0};
  REAL *finnow=NULL, *finother=NULL, *finswap=NULL;
  int finlength=0;

  REAL adxtail=0, bdxtail=0, cdxtail=0, adytail=0, bdytail=0, cdytail=0;
  INEXACT REAL adxadx1=0, adyady1=0, bdxbdx1=0, bdybdy1=0, cdxcdx1=0, cdycdy1=0;
  REAL adxadx0=0, adyady0=0, bdxbdx0=0, bdybdy0=0, cdxcdx0=0, cdycdy0=0;
  REAL aa[4]={0}, bb[4]={0}, cc[4]={0};
  INEXACT REAL aa3=0, bb3=0, cc3=0;
  INEXACT REAL ti1=0, tj1=0;
  REAL ti0=0, tj0=0;
  REAL u[4]={0}, v[4]={0};
  INEXACT REAL u3=0, v3=0;
  REAL temp8[8]={0}, temp16a[16]={0}, temp16b[16]={0}, temp16c[16]={0};
  ...
  REAL axtbb[8]={0}, axtcc[8]={0}, aytbb[8]={0}, aytcc[8]={0};
  int axtbblen=0, axtcclen=0, aytbblen=0, aytcclen=0;
  REAL bxtaa[8]={0}, bxtcc[8]={0}, bytaa[8]={0}, bytcc[8]={0};
  int bxtaalen=0, bxtcclen=0, bytaalen=0, bytcclen=0;
  REAL cxtaa[8]={0}, cxtbb[8]={0}, cytaa[8]={0}, cytbb[8]={0};
  int cxtaalen=0, cxtbblen=0, cytaalen=0, cytbblen=0;
  REAL axtbc[8]={0}, aytbc[8]={0}, bxtca[8]={0}, bytca[8]={0}, cxtab[8]={0}, cytab[8]={0};
  int axtbclen=0, aytbclen=0, bxtcalen=0, bytcalen=0, cxtablen=0, cytablen=0;
  REAL axtbct[16]={0}, aytbct[16]={0}, bxtcat[16]={0}, bytcat[16]={0}, cxtabt[16]={0}, cytabt[16]={0};
  int axtbctlen=0, aytbctlen=0, bxtcatlen=0, bytcatlen=0, cxtabtlen=0, cytabtlen=0;
  REAL axtbctt[8]={0}, aytbctt[8]={0}, bxtcatt[8]={0};
  REAL bytcatt[8]={0}, cxtabtt[8]={0}, cytabtt[8]={0};
  int axtbcttlen=0, aytbcttlen=0, bxtcattlen=0, bytcattlen=0, cxtabttlen=0, cytabttlen=0;
  REAL abt[8]={0}, bct[8]={0}, cat[8]={0};
  int abtlen=0, bctlen=0, catlen=0;
  REAL abtt[4]={0}, bctt[4]={0}, catt[4]={0};
  int abttlen=0, bcttlen=0, cattlen=0;
  INEXACT REAL abtt3=0, bctt3=0, catt3=0;
  REAL negate=0;
...

{
  ...
  struct osub testsub;
  memset(&testsub, 0, sizeof(testsub));
  vertex torg=NULL, tdest=NULL, tapex=NULL;
  vertex base1=NULL, base2=NULL;
  vertex org1=NULL, dest1=NULL, org2=NULL, dest2=NULL;
  vertex joinvertex=NULL;
  REAL dxod=0, dyod=0, dxda=0, dyda=0, dxao=0, dyao=0;
  REAL dxod2=0, dyod2=0, dxda2=0, dyda2=0, dxao2=0, dyao2=0;
  REAL apexlen=0, orglen=0, destlen=0, minedge=0;
  REAL angle=0;
  REAL area=0;
  REAL dist1=0, dist2=0;
  subseg sptr=NULL;                      /* Temporary variable used by tspivot(). */
  triangle ptr=NULL;           /* Temporary variable used by oprev() and dnext(). */
  ...
  if (b->vararea || b->fixedarea || b->usertest) {
    ...
    if(area>0)n=1;
    if((*testtri).tri)n=1;
    if(m->areaboundindex>0)n=1;

    if(((REAL *) (*testtri).tri)[0] > 0)n=1;
    if(m->areaboundindex>=0)
      if((((REAL *) (*testtri).tri)[m->areaboundindex]) > 0)n=1;
    if(m->areaboundindex>=2)
      if((((REAL *) (*testtri).tri)[m->areaboundindex - 2]) > 0)n=1;
    if(areabound(*testtri)>0)n=1;
...

{
  struct otri oppotri;
  struct osub newsubseg;
  vertex triorg=NULL, tridest=NULL;
  triangle ptr;                         /* Temporary variable used by sym(). */
  subseg sptr;                      /* Temporary variable used by tspivot(). */
...
{
  struct otri triangleloop;
  memset(&triangleloop, 0, sizeof(triangleloop));
